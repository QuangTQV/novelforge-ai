...
function buildNextStep(project: DramaProjectDetail): NextStep {
  ...
  return {
    ...
    button: translateUi("导出 Markdown"),
    tab: "export",
    icon: "export",
  };
}
