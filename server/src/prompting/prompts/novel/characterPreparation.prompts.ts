...
function castSystemLines(lang: PromptLanguage, opts: { count: number | null; single: boolean; template: string }): string[] {
  ...
  return [
    ...
    "",
    pick(lang,
      "【深度校准范例】（换一个与当前故事无关的题材，只用于校准“浅”和“深”的差距，禁止照搬其内容或姓名）：",
      "【Ví dụ hiệu chỉnh độ sâu】(một thể loại không liên quan đến câu chuyện hiện tại, chỉ để hiệu chỉnh khoảng cách giữa \"nông\" và \"sâu\", cấm bê nguyên nội dung hoặc tên gọi):",
      "[Depth-calibration example] (a genre unrelated to the current story, only to calibrate the gap between \"shallow\" and \"deep\" — do not copy its content or names):"),
    pick(lang,
      "· 人物：一名退役刺客，现在经营一家花店。outerGoal 太浅：“变得更强”。够深：“必须在哥哥把花店卖给她曾经效力的组织之前，抢到继承权。” wound 太浅：“痛苦的过去”。够深：“19 岁那年，她因为相信一条假命令，亲手杀死了保护自己的人。” misbelief 太浅：“没有人可以信任”。够深：“她以为只要和任何人保持距离，组织就不会拿他们威胁自己——事实恰恰相反，疏远只会让他们更容易被当作人质利用而不被留意。” secret 太浅：“她曾是刺客”。够深：“她每年仍接一单暗杀，固定在她杀错人那天，作为自我惩罚。”",
      "· Nhân vật: một sát thủ giải nghệ, hiện đang mở một tiệm hoa. outerGoal quá nông: \"trở nên mạnh hơn\". Đủ sâu: \"phải giành được quyền thừa kế tiệm hoa trước khi anh trai bán nó cho tổ chức cũ mà cô từng phục vụ.\" wound quá nông: \"quá khứ đau buồn\". Đủ sâu: \"năm 19 tuổi, vì tin vào một mệnh lệnh giả, cô đã tự tay giết chết người từng bảo vệ mình.\" misbelief quá nông: \"không thể tin ai cả\". Đủ sâu: \"cô tưởng rằng chỉ cần giữ khoảng cách với mọi người thì tổ chức sẽ không dùng họ để uy hiếp cô — sự thật ngược lại, sự xa cách chỉ khiến họ dễ bị lợi dụng làm con tin mà không ai để ý.\" secret quá nông: \"cô từng là sát thủ\". Đủ sâu: \"mỗi năm cô vẫn nhận một đơn ám sát, đúng vào ngày cô giết nhầm người năm xưa, như một hình phạt cho chính mình.\"",
      "· Character: a retired assassin who now runs a flower shop. outerGoal too shallow: \"become stronger\". Deep enough: \"must win the shop's inheritance before her brother sells it to the organization she once served.\" wound too shallow: \"a painful past\". Deep enough: \"at 19, trusting a forged order, she personally killed the person who had been protecting her.\" misbelief too shallow: \"no one can be trusted\". Deep enough: \"she believes that staying distant from everyone keeps the organization from using them against her — the opposite is true; distance only makes them easier to take hostage unnoticed.\" secret too shallow: \"she used to be an assassin\". Deep enough: \"she still takes one assassination job a year, always on the anniversary of the person she killed by mistake, as self-punishment.\""),
    pick(lang,
      "· relations 同理：hiddenTension 太浅：“他们之间有矛盾”。够深：“妹妹以为哥哥卖店是为了钱，其实哥哥是在替她提前还清一笔她自己不知道的债，只是选错了买家。” 把同样的具体度用到当前这本书的每个角色身上：每个心理字段都要能让人复述出“具体发生过什么、导致了什么信念、这个信念会在后续被怎样代价高昂地打破”。",
      "· relations cũng vậy: hiddenTension quá nông: \"giữa họ có mâu thuẫn\". Đủ sâu: \"em gái tưởng anh trai bán tiệm vì tiền, nhưng thực ra anh đang âm thầm trả nốt một khoản nợ thay em mà em không hề biết, chỉ là chọn nhầm người mua.\" Áp dụng đúng mức độ cụ thể đó cho mọi nhân vật của cuốn sách hiện tại: mỗi field tâm lý đều phải cho người ta thuật lại được \"cụ thể chuyện gì đã xảy ra, nó dẫn tới niềm tin gì, niềm tin đó sẽ bị phá vỡ với cái giá đắt ra sao về sau\".",
      "· relations follow the same rule: hiddenTension too shallow: \"there is tension between them\". Deep enough: \"the sister thinks her brother is selling the shop for money, but he is actually quietly paying off a debt on her behalf that she doesn't know about — he just picked the wrong buyer.\" Apply that same specificity to every character in the current book: every psychological field must let someone restate \"what concretely happened, what belief it produced, and how that belief will later be broken at a real cost\"."),
    "",
