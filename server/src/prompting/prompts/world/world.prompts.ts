...
> = {
  ...
  render: (input) => [
    new SystemMessage([
      ...
      "",
      "全局硬规则：",
      "1. 所有文本必须使用目标语言（默认简体中文，以末尾“输出语言指令”为准）。",
...
> = {
  ...
  render: (input) => [
    new SystemMessage([
      ...
      "",
      "只输出一个合法 JSON 对象，不要输出 Markdown、解释、注释、代码块或额外文本。",
      "所有文本字段都必须使用目标语言（默认简体中文，以末尾“输出语言指令”为准）。",
      "",
      "输出结构必须严格为：",
      "{",
      '  "worldType":"...",',
      ...
      new SystemMessage(
        isReferenceMode
          ? [
              ...
              "2. 所有文本必须使用目标语言（默认简体中文，以末尾“输出语言指令”为准）。",
  ...
  render: (input) => [
    new SystemMessage(
      [
        ...
        "4. 所有字段值必须使用目标语言（默认简体中文，以末尾“输出语言指令”为准）。",
...
> = {
  ...
  render: (input) => [
    new SystemMessage([
      ...
      "",
      "只输出一个合法 JSON 数组，不要输出 Markdown、解释、注释、代码块或额外文本。",
      "数组元素必须全部是字符串，且全部使用目标语言（默认简体中文，以末尾“输出语言指令”为准）。",
      "必须精确输出 5 条，不能多也不能少。",
      "",
      "全局硬规则：",
